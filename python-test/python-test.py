# -*- coding: utf-8 -*-
#
# WorldEdit Documentation documentation build configuration file, created by
...
htmlhelp_basename = 'WorldEditDocumentationdoc'
...
latex_documents = [
    ('index', 'WorldEditDocumentation.tex', u'WorldEdit Documentation Documentation',
     u'WorldEdit Team', 'manual'),
]
...
man_pages = [
    ('index', 'worldeditdocumentation', u'WorldEdit Documentation Documentation',
     [u'WorldEdit Team'], 1)
]
...
texinfo_documents = [
    ('index', 'WorldEditDocumentation', u'WorldEdit Documentation Documentation',
     u'WorldEdit Team', 'WorldEditDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
